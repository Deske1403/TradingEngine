...
DROP VIEW IF EXISTS v_funding_shadow_session_vs_actual CASCADE;
DROP VIEW IF EXISTS v_funding_shadow_action_vs_actual CASCADE;
...
-- 2.26 funding_shadow_actions
CREATE TABLE funding_shadow_actions (
    id                    BIGSERIAL       PRIMARY KEY,
    utc                   TIMESTAMPTZ     NOT NULL,
    exchange              TEXT            NOT NULL,
...
-- 2.27 funding_shadow_action_sessions
CREATE TABLE funding_shadow_action_sessions (
    id                    BIGSERIAL       PRIMARY KEY,
    exchange              TEXT            NOT NULL,
...
-- 2.29 funding_reconciliation_log
...
-- funding_shadow_actions
CREATE INDEX ix_funding_shadow_actions_exchange_symbol_utc
    ON funding_shadow_actions (exchange, symbol, utc DESC);

CREATE INDEX ix_funding_shadow_actions_action_utc
    ON funding_shadow_actions (action, utc DESC);

-- funding_shadow_action_sessions
CREATE INDEX ix_funding_shadow_action_sessions_exchange_symbol_opened
    ON funding_shadow_action_sessions (exchange, symbol, opened_utc DESC);

CREATE INDEX ix_funding_shadow_action_sessions_status_opened
